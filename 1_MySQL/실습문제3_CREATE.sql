...
INSERT INTO publisher(pub_name, phone) VALUES('길벗', '02-322-0931');
...
CREATE TABLE book (
    ...
    INSERT INTO book(bk_title, bk_author, bk_price, pub_no) 
    VALUE('1일 1로그 100일 완성IT 지식', '브라이언 W.커니핸', 200000, 2);
    INSERT INTO book(bk_title, bk_author, bk_price, pub_no) 
    VALUE('개발자가 영어도 잘해야 하나요?', '최희철', 27000, 3);
    INSERT INTO book(bk_title, bk_author, bk_price, pub_no) 
    VALUE('피플웨어', '톰 드마르코', 16800, 2);
    INSERT INTO book(bk_title, bk_author, bk_price, pub_no) 
    VALUE('그로스 해킹', '라이언 홀리데이', 13800, 3);
    SELECT * FROM book;
...
CREATE TABLE member(
    ...
    address VARCHAR(80),
    phone VARCHAR(20),
    status VARCHAR(3) CHECK(status IN ('Y', 'N')) DEFAULT 'N',
    enroll_date DATE DEFAULT (current_date) 
);
INSERT INTO member(member_id, member_pwd, member_name, gender, address, phone, status, enroll_date) 
VALUES('user01', 'pass01', '가나다', 'M', '서울시 강남구', '010-1111-2222', 'N', '2024-06-24');
INSERT INTO member(member_id, member_pwd, member_name, gender, address, phone, status, enroll_date) 
VALUES('user02', 'pass02', '라마바', 'M', '서울시 서초구', '010-3333-4444', 'N', '2024-06-24');
INSERT INTO member(member_id, member_pwd, member_name, gender, address, phone, status, enroll_date) 
VALUES('user03', 'pass03', '사아자', 'F', '경기도 광주시', '010-4444-5555', 'N', '2024-06-24');
SELECT * FROM member;
...
CREATE TABLE rent(
    ...
    rent_mem_no VARCHAR(20),
    rent_book_no VARCHAR(20),
    rent_date DATE DEFAULT (current_date)
);
INSERT INTO rent(rent_mem_no, rent_book_no, rent_date)
VALUE( 1, 2, '2024-06-24');
INSERT INTO rent(rent_mem_no, rent_book_no, rent_date)
VALUE( 1, 3, '2024-06-24');
INSERT INTO rent(rent_mem_no, rent_book_no, rent_date)
VALUE( 2, 1, '2024-06-24');
INSERT INTO rent(rent_mem_no, rent_book_no, rent_date)
VALUE( 2, 2, '2024-06-24');
INSERT INTO rent(rent_mem_no, rent_book_no, rent_date)
VALUE( 1, 5, '2024-06-24');
SELECT * FROM rent;
