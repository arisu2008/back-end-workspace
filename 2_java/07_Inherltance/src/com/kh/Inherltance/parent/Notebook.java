...
public class Notebook extends product {
	...
	public String toString() {
		return "Notebook [cpu=" + cpu + ", pCode=" + pCode + ", name=" + name + ", getBrand()=" + getBrand()
				+ ", getpCode()=" + getpCode() + ", getName()=" + getName() + ", getPrice()=" + getPrice()
...
//	super.pCode = pCode; // 부모가 default - 같은 패키지에 있어야만 직접 접근 O
	super.name = name; // 부모가 protected - 상속관계일 떄 자식 객체에서 직접 접근 O
